                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="relative group/info">
                                        ...
                                        {/* Smart Downward Tooltip */}
                                        <div className="absolute top-full mt-3 right-0 w-72 bg-slate-900 border border-slate-700 rounded-2xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] opacity-0 group-hover/info:opacity-100 pointer-events-none transition-all z-[200] translate-y-1 group-hover/info:translate-y-0">
                                            {/* Pointer at top */}
                                            <div className="absolute bottom-full right-4 w-3 h-3 bg-slate-900 border-l border-t border-slate-700 rotate-45 translate-y-1.5"></div>
